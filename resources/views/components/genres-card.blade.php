<div class="mt-8">
    <a href="{{ route('movies.show', $result['id']) }}">
        <img src="{{ $result['poster_path'] }}" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150">
    </a>
    <div class="mt-2">
        <a href="{{ route('movies.show', $result['id']) }}" class="text-lg mt-2 hover:text-gray:300">
            {{ $result['title']}}
        </a>
        ...
        <div class="text-gray-400 text-sm">{{ $result['genres'] }}</div>
    </div>
</div>